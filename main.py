...
from methods.functions import df2b, df2c, f2b, f2c, get_f2b_range, get_f2c_range
...
def roots(request: Request):
    return templates.TemplateResponse(request, "roots.html", { "greeting": "Hello World" })


@app.get("/equationssystem", response_class=HTMLResponse)
def equationssystem(request: Request):
    return templates.TemplateResponse(request, "equationssystem.html", { "greeting": "Hello World" })


@app.get("/roots/1b", response_class=HTMLResponse)
def bisection1b(request: Request):
    return templates.TemplateResponse(request, "roots_solution.html", { "greeting": "Hello World" })
...
def equationssystem(request: Request):
    return templates.TemplateResponse(request, "equationssystem_solution.html", { "greeting": "Hello World" })
